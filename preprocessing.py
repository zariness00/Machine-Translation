...
data_path = r"C:\Users\exol1\Machine-Translation\rus.txt"

# Defining lines as a list of each line
with open(data_path, 'r', encoding='utf-8') as f:
  lines = f.read().split('\n')

# print("Checking what I got: ")
# print(lines[:5])
...
print("Printing input features dict ")
print(list(input_features_dict.keys())[:50])
print("Printing reverse target features dict")
print(reverse_target_features_dict[50])
print("Printing the length of input tokens")
